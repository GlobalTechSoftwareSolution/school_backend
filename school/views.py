...
class UserViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request):
        """
        GET /api/users/
        Returns user records with optional pagination.
...
class DepartmentViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request):
        """
        GET /api/departments/
        Returns department records with optional pagination.
        If page or page_size parameters are provided, pagination is enabled.
        Otherwise, all records are returned (filtered by other parameters).
        """
        # Check if pagination parameters are provided
...
class SubjectViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request):
        """
        GET /api/subjects/
        Returns subject records with optional pagination.
        If page or page_size parameters are provided, pagination is enabled.
        Otherwise, all records are returned (filtered by other parameters).
        """
        # Check if pagination parameters are provided
...
class ClassViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request):
        """
        GET /api/classes/
        Returns class records with optional pagination.
        If page or page_size parameters are provided, pagination is enabled.
        Otherwise, all records are returned (filtered by other parameters).
        """
        # Check if pagination parameters are provided
...
class AwardViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request):
        """
        GET /api/awards/
        Returns award records with optional pagination.
        If page or page_size parameters are provided, pagination is enabled.
        Otherwise, all records are returned (filtered by other parameters).
        """
        # Check if pagination parameters are provided
...
class IDCardViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request):
        """
        GET /api/idcards/
        Returns ID card records with optional pagination.
        If page or page_size parameters are provided, pagination is enabled.
        Otherwise, all records are returned (filtered by other parameters).
        """
        # Check if pagination parameters are provided
...
class TimetableViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request):
        """
        GET /api/timetables/
        Returns timetable records with optional pagination.
        If page or page_size parameters are provided, pagination is enabled.
        Otherwise, all records are returned (filtered by other parameters).
        """
        # Check if pagination parameters are provided
...
class PrincipalViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request):
        """
        GET /api/principals/
        Returns principal records with optional pagination.
        If page or page_size parameters are provided, pagination is enabled.
        Otherwise, all records are returned (filtered by other parameters).
        """
        # Check if pagination parameters are provided
...
class ManagementViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request):
        """
        GET /api/managements/
        Returns management records with optional pagination.
        If page or page_size parameters are provided, pagination is enabled.
        Otherwise, all records are returned (filtered by other parameters).
        """
        # Check if pagination parameters are provided
...
class AdminViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request):
        """
        GET /api/admins/
        Returns admin records with optional pagination.
        If page or page_size parameters are provided, pagination is enabled.
        Otherwise, all records are returned (filtered by other parameters).
        """
        # Check if pagination parameters are provided
...
class ParentViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request):
        """
        GET /api/parents/
        Returns parent records with optional pagination.
        If page or page_size parameters are provided, pagination is enabled.
        Otherwise, all records are returned (filtered by other parameters).
        """
        # Check if pagination parameters are provided
...
class GradeViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request):
        """
        GET /api/grades/
        Returns grade records with optional pagination.
        If page or page_size parameters are provided, pagination is enabled.
        Otherwise, all records are returned (filtered by other parameters).
        """
        # Check if pagination parameters are provided
...
class FeeStructureViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request):
        """
        GET /api/fee_structures/
        Returns fee structure records with optional pagination.
        If page or page_size parameters are provided, pagination is enabled.
        Otherwise, all records are returned (filtered by other parameters).
        """
        # Check if pagination parameters are provided
...
class FeePaymentViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request):
        """
        GET /api/fee_payments/
        Returns fee payment records with optional pagination.
        If page or page_size parameters are provided, pagination is enabled.
        Otherwise, all records are returned (filtered by other parameters).
        """
        # Check if pagination parameters are provided
...
class ActivityViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request):
        """
        GET /api/activities/
        Returns activity records with optional pagination.
        If page or page_size parameters are provided, pagination is enabled.
        Otherwise, all records are returned (filtered by other parameters).
        """
        # Check if pagination parameters are provided
...
class FormerMemberViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def list(self, request):
        """
        GET /api/former_members/
        Returns former member records with optional pagination.
        If page or page_size parameters are provided, pagination is enabled.
        Otherwise, all records are returned (filtered by other parameters).
        """
        # Check if pagination parameters are provided
...
class ProgramViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request):
        """
        GET /api/programs/
        Returns program records with optional pagination.
        If page or page_size parameters are provided, pagination is enabled.
        Otherwise, all records are returned (filtered by other parameters).
        """
        # Check if pagination parameters are provided
...
class ReportViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request):
        """
        GET /api/reports/
        Returns report records with optional pagination.
        If page or page_size parameters are provided, pagination is enabled.
        Otherwise, all records are returned (filtered by other parameters).
        """
        # Check if pagination parameters are provided
...
class FinanceTransactionViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request):
        """
        GET /api/finance/
        Returns finance transaction records with optional pagination.
        If page or page_size parameters are provided, pagination is enabled.
        Otherwise, all records are returned (filtered by other parameters).
        """
        # Check if pagination parameters are provided
...
class TransportDetailsViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request):
        """
        GET /api/transport_details/
        Returns transport details records with optional pagination.
        If page or page_size parameters are provided, pagination is enabled.
        Otherwise, all records are returned (filtered by other parameters).
        """
        # Check if pagination parameters are provided
...
class NoticeViewSet(viewsets.ModelViewSet):
    ...
    def list(self, request):
        """
        GET /api/notices/
        Returns notice records with optional pagination.
        If page or page_size parameters are provided, pagination is enabled.
        Otherwise, all records are returned (filtered by other parameters).
        """
        # Check if pagination parameters are provided
...
def password_reset_request(request):
    ...
    if serializer.is_valid():
        ...
        try:
            ...
            # Create reset link
            reset_link = f"https://school.globaltechsoftwaresolutions.cloud/reset_password/{uid}/{token}"
